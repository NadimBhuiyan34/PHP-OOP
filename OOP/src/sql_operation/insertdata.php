...
public function sell_book($post)
{
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO `sell_book`(`book_title`, `book_author`, `book_edition`, `book_quantity`, `mobile`, `book_image`) VALUES (' $booktitle','  $bookauthor','$bookedition','$bookquantit','$mobile',' $bookimage')";
