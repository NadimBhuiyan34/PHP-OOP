...
<!-- Slider Start -->
 <div class="container">
     ...
     <table class="table table-bordered">
      ...
      <a href="shipping_order.php"> <button class="btn btn-warning text-white" style="margin-left:500px;margin-bottom:40px;">Go to Shipping</button></a>
 </div>
