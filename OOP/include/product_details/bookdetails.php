...
<div class="container card " style="background-color: #c8f7f7;margin-bottom: 100px;">
    ...
    <div class="row justify-content-center">
         <div class="col-3 card m-3  rounded" style="background-color: #c5f0ef;">
           
			<div id="carouselExampleControlsNoTouching" class="carousel slide m-2" data-bs-touch="false" data-bs-interval="false">
				<div class="carousel-inner" >
				  <div class="carousel-item active">
					<img src="images/1.png" class="d-block w-100" alt="..." style="height:300px ;">
				  </div>
				  <div class="carousel-item">
					<img src="images/2.png" class="d-block w-100" alt="..." style="height:300px ;">
				  </div>
				  <div class="carousel-item">
					<img src="images/3.png" class="d-block w-100" alt="..." style="height:300px ;">
				  </div>
				</div>
         ...
         <div class="col-5 m-3">
           <address class="">
               <p><b>Book Title: </b>  SQL</p>
               <p><b>Book Author: </b>  ANTHONY HACK</p>
               <p><b>Book Edition: </b>  5th</p>
               <p><b>Price: </b>250 Taka</p>
               <p><b>Mobile Number: </b>  01305795830</p>
