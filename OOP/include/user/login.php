...
<!-- Slider Start -->
 ...
 <div class="container">
     <div class="card col-5 " style="margin-left:300px ;">
         ...
         <div class="card-body">
            <form action="/action_page.php">
                ...
                <a href="signup.html" class="text-info">Create an Account</a>  <a href="forgetpassword.html" class="ml-5">Forget Password</a>
              </form>
         </div>
     </div>
 </div>
