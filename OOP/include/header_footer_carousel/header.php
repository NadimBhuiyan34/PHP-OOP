 <?php
 $root="http://localhost/Book_Store_Demo/include/";
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header>
	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
		 	 <a class="navbar-brand" href="http://localhost/Book_Store_Demo/home.php">
			  	<img src="http://localhost/Book_Store_Demo/images/uboighar.png" alt="" class="img-fluid">
			  </a>
			...
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a class="dropdown-item" href="http://localhost/Book_Store_Demo/include/product_page/old_book.php">OLD BOOK</a></li>
			   ...
			   <li class="nav-item"><a class="nav-link" href="http://localhost/Book_Store_Demo/include/book_form/sellbook.php">SELL BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="http://localhost/Book_Store_Demo/include/book_form/requestbook.php">REQUEST BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="http://localhost/Book_Store_Demo/include/book_form/donatebook.php">DONATE  BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="http://localhost/Book_Store_Demo/include/product_page/earnmoney.php">ERAN MONEY</a></li>
			  	...
			  	<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						...
						<li><a class="dropdown-item" href="http://localhost/Book_Store_Demo/include/more_page/aboutus.php">ABOUT US</a></li>
