...
<div class="container ">
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <div class="col-sm-11">
                <input type="email" id="book author" placeholder="Email" class="form-control" autofocus>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input type="phoneNumber" id="phoneNumber" placeholder="Your Address" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input type="phoneNumber" id="phoneNumber" placeholder="Reason" class="form-control">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="margin-left:170px ;">SUBMIT
        </button>
        </div> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Get Donate Book</h4>
        ...
        <div class="modal-body">
            <div class="alert alert-success">
              ...
              <strong>   You Request is Received  </strong>Please Wait..We will contact you after verification
              </div>
        </div>
